  ...
  const features = [
    {
      ...
      description: "AdeptAI’s Analytics Suite is designed to provide healthcare organizations with the intelligence they need to make proactive, informed decisions about workforce management and strategic planning.",
    ...
    },
    {
      ...
      description: "AdeptAI’s Professional Development Portal empowers healthcare professionals to take charge of their growth while helping organizations cultivate a highly skilled and engaged workforce..",
    ...
    },
    {
      ...
      description: "AdeptAI’s AI-Driven Matchmaking Engine is a transformative feature that redefines recruitment in healthcare, addressing the industry’s ongoing challenges with precision and innovation.",
    ...
    },
    {
      ...
      description: "AdeptAI’s Compliance Management System is a robust solution that automates and simplifies the intricacies of credentialing and compliance, allowing healthcare organizations to operate with peace of mind.",
