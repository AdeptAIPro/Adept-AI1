...
const Pricing = () => {
  ...
  const pricingPlans = [
    {
      name: "Trial",
      description: "Designed for small practices with 1–5 providers",
      price: "Free",
      period: "per month",
      features: [
        "AI-Driven Matchmaking Engine",
        "Add-On Features (Pay-As-You-Go)",
      ],
      cta: "Get Started",
      popular: false,
    },
    ...
    },
    {
      ...
      description: "Designed for mid-sized organizations with 6–50 providers",
      price: "$999",
      period: "contact for pricing",
      features: [
        "Includes all Basic Tier features, plus",
        "AI-Driven Matchmaking Engine",
        "Analytics Suite (Basic Features)",
        "Compliance Management System (Full Suite)",
        "Integrations & APIs",
        "Support",
        "Add-On Features (Pay-As-You-Go)",
